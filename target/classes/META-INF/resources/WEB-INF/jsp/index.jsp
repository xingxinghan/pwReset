...
<div id="app">
	<div class="container">
		...
		<div class="row" style="margin-top: 100px;">
			<div class="text-center" id="title">
				<h1 style="font-family:LiSu">若需要修改上网密码，请先贴卡 </h1>
		...
		<div class="row" style="margin-top: 50px;" >
			...
			<div class="col-md-5 col-md-offset-4">
				<p>提示：若不显示学工号，请先前往卡务中心处理一卡通问题！</p>
				...
				<div class="modal-body">
					<form class="form-horizontal" name="IDinput">
						...
						<div class="row" id="boarder">
							<div class="col-md-8">
								<div>
									<button type="button" class="btn btn-lg" @click="one">1</button>
							...
							<div>
								<button type="button" class="btn btn-danger btn-lg" style="width:70px;height:105px;" @click="del">删除</button>
								
								<button type="button" class="btn btn-warning btn-lg" style="width:70px;height:105px;" @click="clr">清空</button>
							</div>
	...
	function isnull(val) {
		...
		function validateID(){
			...
			window.location.href="${pageContext.request.contextPath }/validateID?uid="+$('#uid').val()+"&iD_num="+ID;
		}; 
